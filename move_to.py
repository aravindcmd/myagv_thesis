...
class map_navigation():
  ...
  def __init__(self):
    ...
    if (choice == 0):
      ...
      self.goalReached = self.moveToGoal(self.xCafe, self.yCafe,self.z_cafe,self.w_cafe)
  ...
  def moveToGoal(self,xGoal,yGoal,z_cafe,w_cafe):
      ...
      goal.target_pose.pose.orientation.z =  z_cafe
      goal.target_pose.pose.orientation.w =  w_cafe
